...
function Portfolio() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900 select-none">
      <div
        className={`z-10 text-white tracking-wider flex flex-col items-center max-w-3xl px-6 py-8 sm:py-12 lg:pt-24 mx-auto transition-all duration-700 ${
      ...
      >
        <header className="mb-6 flex flex-col justify-between items-center text-center w-full">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl mb-4 font-bold text-light-gray">
            Aashu Sailani
          </h1>
          {/* Social links */}
          <div className='flex gap-5 mb-4'>
            ...
            <div
              ...
              <span className="cursor-pointer [&>svg]:h-8 [&>svg]:w-8 [&>svg]:fill-[rgb(100,100,100)] hover:[&>svg]:fill-[rgb(255,235,235)] [&>svg]:transition [&>svg]:duration-200 [&>svg]:ease-in-out">
            ...
            <div 
              ...
              className="cursor-pointer" >
              <span className="cursor-pointer [&>svg]:h-8 [&>svg]:w-8 [&>svg]:fill-[rgb(100,100,100)] hover:[&>svg]:fill-[rgb(255,255,235)] [&>svg]:transition [&>svg]:duration-200 [&>svg]:ease-in-out">
